...
public class GainChanger : MonoBehaviour
{
    ...
    [Header("Gain Parameters (LiftGammaGain)")]
    [Range(-1f, 2f)] public float fixedGainValue = 0f;
    [Range(-1f, 2f)] public float minGainValue = 0f;
    [Range(-1f, 2f)] public float maxGainValue = 0f;
    ...
    void Update()
    {
        ...
        Vector4 gain = liftGammaGain.gain.value;
        float t = 0f;
        float value = 0f;
        ...
        switch (mode)
        {
            case Mode.Linear:
                ...
                gain.w = Mathf.Lerp(minGainValue, maxGainValue, t);
